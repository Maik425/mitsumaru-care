...
export function SkillsManagement() {
  const [skills, setSkills] = useState([
    { id: 1, name: "入浴介助", category: "身体介護", level: 1, description: "利用者の入浴をサポートする技能" },
    { id: 2, name: "食事介助", category: "身体介護", level: 1, description: "食事の際の介助を行う技能" },
    { id: 3, name: "移乗介助", category: "身体介護", level: 3, description: "車椅子やベッドへの移乗をサポート" },
    { id: 4, name: "服薬管理", category: "医療", level: 5, description: "薬の管理・服薬確認を行う技能" },
    { id: 5, name: "記録業務", category: "事務", level: 1, description: "介護記録の作成・管理" },
    { id: 6, name: "レクリエーション", category: "生活支援", level: 3, description: "利用者向けの活動企画・実施" },
  ])
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <h1 className="text-xl font-semibold text-gray-900 ml-4">技能登録</h1>
          </div>
        </div>
      </header>
