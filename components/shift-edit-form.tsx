...
// interface ConfigurationRule { // 未使用のためコメントアウト
//   id: string;
...
// interface SpecialEvent { // 未使用のためコメントアウト
//   id: string;
...
export function ShiftEditForm(props: {
  ...
  const [line] = useState(initialLine);
  ...
  // const [configurationRules, setConfigurationRules] = useState< // 未使用のためコメントアウト
  //   ConfigurationRule[]
  // >([
  //   {
  //     id: '1',
  ...
  // const [showRuleForm, setShowRuleForm] = useState(false); // 未使用のためコメントアウト
  // const [editingRule, setEditingRule] = useState<ConfigurationRule | null>( // 未使用のためコメントアウト
  //   null
  // );
  // const [ruleFormData, setRuleFormData] = useState<Partial<ConfigurationRule>>({ // 未使用のためコメントアウト
  //   type: 'specific_dates',
  //   name: '',
  //   description: '',
  ...
  // const [showDatePicker, setShowDatePicker] = useState(false); // 未使用のためコメントアウト
  ...
  // const [specialEvents, setSpecialEvents] = useState<SpecialEvent[]>([ // 未使用のためコメントアウト
  //   {
  //     id: '1',
  //     type: 'business_trip',
  //     title: '鈴木一郎 出張',
  ...
  const [requestedLeaves] = useState<LeaveRequest[]>([
  ...
  // const openRuleForm = (rule?: ConfigurationRule) => { // 未使用のためコメントアウト
  //   if (rule) {
  //     setEditingRule(rule);
  ...
  // const saveConfigurationRule = () => { // 未使用のためコメントアウト
  ...
  // const removeConfigurationRule = (id: string) => { // 未使用のためコメントアウト
  //   setConfigurationRules(configurationRules.filter(rule => rule.id !== id));
  // };

  // const toggleRuleActive = (id: string) => { // 未使用のためコメントアウト
  //   setConfigurationRules(
  //     configurationRules.map(rule =>
  ...
  // const generateDateOptions = () => { // 未使用のためコメントアウト
  //   const dates = [];
  //   for (let day = 1; day <= daysInMonth; day++) {
  ...
  // const toggleDateSelection = (date: string) => { // 未使用のためコメントアウト
  ...
  // const formatDateForDisplay = (dateStr: string) => { // 未使用のためコメントアウト
  //   const [, , day] = dateStr.split('-');
  //   return `${month}/${Number.parseInt(day)}`;
  // };

  // const removeSpecialEvent = (id: string) => { // 未使用のためコメントアウト
  ...
  const ShiftTablePreview = ({ pattern }: { pattern: ShiftPattern }) => {
    ...
    // const getStaffShiftForDate = ( // 未使用のためコメントアウト
    //   staffName: string,
    //   // date: string, // 未使用のためコメントアウト
    //   shifts: any
    // ) => {
