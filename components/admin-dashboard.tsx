...
import { Calendar, Users, Clock, Settings, FileText, HelpCircle, Building2, LogOut, ClipboardList } from "lucide-react"
...
export function AdminDashboard() {
  const menuItems = [
    ...
    },
    {
      title: "各種登録管理",
      items: [
        { name: "シフト形態管理", href: "/admin/settings/attendance-types", icon: Clock },
        { name: "役職登録", href: "/admin/settings/positions", icon: Users },
        { name: "技能登録", href: "/admin/settings/skills", icon: Settings },
        { name: "職種・配置ルール登録", href: "/admin/settings/job-rules", icon: Settings },
        { name: "役割表登録", href: "/admin/settings/role-templates", icon: FileText },
        { name: "勤怠管理登録", href: "/admin/settings/attendance-management", icon: ClipboardList },
        { name: "ログインアカウント登録", href: "/admin/settings/accounts", icon: Users },
      ],
    },
    {
      title: "勤怠確認",
