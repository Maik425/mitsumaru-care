...
export function JobRulesManagement() {
  const [jobRuleTemplates, setJobRuleTemplates] = useState<JobRuleTemplate[]>([
    {
      ...
      jobAreaSets: [
        { id: "1-1", jobType: "介護福祉士", area: "1階フロア", minAssignment: 2, maxAssignment: 4 },
        { id: "1-2", jobType: "看護師", area: "全フロア", minAssignment: 1, maxAssignment: 2 },
        { id: "1-3", jobType: "介護士", area: "2階フロア", minAssignment: 1, maxAssignment: 3 },
      ],
    ...
    },
    {
      ...
      jobAreaSets: [
        { id: "2-1", jobType: "介護福祉士", area: "1階フロア", minAssignment: 1, maxAssignment: 2 },
        { id: "2-2", jobType: "看護師", area: "全フロア", minAssignment: 1, maxAssignment: 1 },
        { id: "2-3", jobType: "介護士", area: "2階フロア", minAssignment: 1, maxAssignment: 2 },
      ],
  ...
  const jobTypes = ["介護福祉士", "看護師", "介護士", "管理者", "生活相談員", "機能訓練指導員"]
  const areas = ["1階フロア", "2階フロア", "3階フロア", "全フロア", "特別室", "デイサービス", "訪問介護", "カスタム"]

  const addJobAreaSet = () => {
    const finalAreaName = currentSet.area === "カスタム" ? currentSet.customAreaName : currentSet.area

    if (currentSet.jobType && finalAreaName && currentSet.minAssignment && currentSet.maxAssignment) {
      const newSet = {
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <h1 className="text-xl font-semibold text-gray-900 ml-4">配置ルールテンプレート管理</h1>
          </div>
        </div>
      </header>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="border-t pt-4">
                    <h3 className="text-sm font-medium text-gray-900 mb-3">職種・エリアセットを追加</h3>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setCurrentSet({ ...currentSet, jobType: value })}
                          >
                            <SelectTrigger>
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) => setCurrentSet({ ...currentSet, area: value, customAreaName: "" })}
                          >
                            <SelectTrigger>
                      ...
                      {currentSet.area === "カスタム" && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setCurrentSet({ ...currentSet, customAreaName: e.target.value })}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setCurrentSet({ ...currentSet, minAssignment: e.target.value })}
                            placeholder="1"
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setCurrentSet({ ...currentSet, maxAssignment: e.target.value })}
                            placeholder="8"
                          />
                        </div>
                      </div>

                      <Button onClick={addJobAreaSet} variant="outline" size="sm" className="w-full bg-transparent">
                  ...
                  {formData.jobAreaSets.length > 0 && (
                    <div className="border-t pt-4">
                      <h3 className="text-sm font-medium text-gray-900 mb-3">追加されたセット</h3>
                      <div className="space-y-2">
                        {formData.jobAreaSets.map((set, index) => (
                          <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div className="flex items-center space-x-2">
                              <Badge className="bg-blue-100 text-blue-800">{set.jobType}</Badge>
                  ...
                  <Button
                    ...
                    className="w-full"
                    disabled={!formData.templateName || formData.jobAreaSets.length === 0}
                  >
                    テンプレートを保存
                  </Button>
                </div>
                    ...
                    <div key={template.id} className="p-4 border border-gray-200 rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 mt-1">作成日: {template.createdAt}</p>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        {template.jobAreaSets.map((set) => (
                          <div key={set.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <div className="flex items-center space-x-2">
                              <Badge className="bg-blue-100 text-blue-800 text-xs">{set.jobType}</Badge>
