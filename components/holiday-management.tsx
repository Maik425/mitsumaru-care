...
export default function HolidayManagement() {
  ...
  // const [selectedStaff, setSelectedStaff] = useState(''); // 未使用のためコメントアウト
  // const [selectedHolidayType, setSelectedHolidayType] = useState('公休'); // 未使用のためコメントアウト
  // const [selectedDates, setSelectedDates] = useState<string[]>([]); // 未使用のためコメントアウト
  ...
  // const getCalendarData = () => { // 未使用のためコメントアウト
  ...
  // const getHolidaysForDate = (date: number) => { // 未使用のためコメントアウト
  //   const [year, month] = selectedMonth.split('-').map(Number);
